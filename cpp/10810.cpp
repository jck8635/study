...
//M개의 줄에 걸쳐서 공을 넣는 방법이 주어진다. 각 방법은 세 정수 i j k로 이루어져 있으며, i번 바구니부터 j번 바구니까지에 k번 번호가 적혀져 있는 공을 넣는다는 뜻이다. 
...
int main() {
	...
	//마무리가 된 후 바구니에 들어있는 공의 번호를 출력한다.
	for (int b = 0; b < N; b++)
	{
		cout << basket[b] << " ";
	}
